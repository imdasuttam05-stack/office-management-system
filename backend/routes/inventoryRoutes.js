...
router.post("/masters/customers",auth,requireRole("Admin","Manager"),createCustomerMaster);
router.put("/masters/customers/:id",auth,requireRole("Admin","Manager"),updateCustomerMaster);
router.delete("/masters/customers/:id",auth,requireRole("Admin","Manager"),deleteCustomerMaster);
