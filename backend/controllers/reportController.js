...
export async function exportSalarySlipExcel(req, res) {
  try {
    ...
    const rows = [
      ...
      [],
      ["Actuals", "Earnings", "", "Deductions", "Amount"],
      ["Basic", slip.earnings.basic, "", "ESI Employee", slip.deductions.esi],
      ["HRA", slip.earnings.hra, "", "PF Employee", slip.deductions.pf],
      ["Conveyance", slip.earnings.conveyance, "", "Professional Tax", slip.deductions.professionalTax],
      ["Others", slip.earnings.others, "", "Others", slip.deductions.other],
      ["Total Rs.", slip.totals.earnings, "", "Rs.", slip.totals.deductions],
      [],
